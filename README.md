...
- `./code/scripts/`: Contains the Rmarkdown file that details all the code used to perform the analysis (command line tools, settings, etc.) as well and the R code used to plot the data.
